...
class TaskAssignmentFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TaskAssignmentFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TaskAssignmentFeedback(null);
...
module.exports = TaskAssignmentFeedback;

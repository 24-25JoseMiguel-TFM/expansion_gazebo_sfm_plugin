...
"""autogenerated by genpy from gazebo_sfm_plugin/Update_waypointRequest.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Update_waypointRequest, self).__init__(*args, **kwds)
...
def _get_struct_3d():
    ...
    return _struct_3d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from gazebo_sfm_plugin/Update_waypointResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class Update_waypointResponse(genpy.Message):
  _md5sum = "358e233cde0c8a8bcfea4ce193f8fc15"
  _type = "gazebo_sfm_plugin/Update_waypointResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """bool success  # Respuesta: true si la trayectoria se actualizó correctamente
"""
  __slots__ = ['success']
  _slot_types = ['bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Update_waypointResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are

...
"""autogenerated by genpy from gazebo_sfm_plugin/TaskAssignmentAction.msg. Do not edit."""
import codecs
import sys
...
import gazebo_sfm_plugin.msg
import genpy
import geometry_msgs.msg
import std_msgs.msg

class TaskAssignmentAction(genpy.Message):
  _md5sum = "6ca05aa8aee82081e20d04ecc8c4ebdb"
  _type = "gazebo_sfm_plugin/TaskAssignmentAction"
...
"""
  ...
  _slot_types = ['gazebo_sfm_plugin/TaskAssignmentActionGoal','gazebo_sfm_plugin/TaskAssignmentActionResult','gazebo_sfm_plugin/TaskAssignmentActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TaskAssignmentAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = gazebo_sfm_plugin.msg.TaskAssignmentActionGoal()
      if self.action_result is None:
        self.action_result = gazebo_sfm_plugin.msg.TaskAssignmentActionResult()
      if self.action_feedback is None:
        self.action_feedback = gazebo_sfm_plugin.msg.TaskAssignmentActionFeedback()
    else:
      self.action_goal = gazebo_sfm_plugin.msg.TaskAssignmentActionGoal()
      self.action_result = gazebo_sfm_plugin.msg.TaskAssignmentActionResult()
      self.action_feedback = gazebo_sfm_plugin.msg.TaskAssignmentActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.task_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.task_names:
        length = len(val1)
      ...
      length = len(self.action_goal.goal.target_types)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.target_types:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.task_names = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.task_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.target_types = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.target_types.append(val1)
      _x = self
      start = end
      end += 12

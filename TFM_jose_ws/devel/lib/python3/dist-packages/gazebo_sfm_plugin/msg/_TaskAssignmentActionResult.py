...
"""autogenerated by genpy from gazebo_sfm_plugin/TaskAssignmentActionResult.msg. Do not edit."""
import codecs
import sys
...
class TaskAssignmentActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "gazebo_sfm_plugin/TaskAssignmentActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gazebo_sfm_plugin/TaskAssignmentResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TaskAssignmentActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = gazebo_sfm_plugin.msg.TaskAssignmentResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = gazebo_sfm_plugin.msg.TaskAssignmentResult()
